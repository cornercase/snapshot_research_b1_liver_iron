    ...
    for FEselect = runcounter:length(FE)        
        ...
        %for runsIndx = 1
            ...
            if hpcc == 1
                ...
                ClusterInfo.setUserNameOnCluster('eamondoy');
                ClusterInfo.setPrivateKeyFile('/Users/eamon/.ssh/id_rsa');
                ClusterInfo.setPrivateKeyFileHasPassPhrase(false);
                %ClusterInfo.setWallTime('48:00:00');
                %ClusterInfo.setQueueName('largemem');
                job = batch(cluster,'ParallelSimCluster','AttachedFiles',{'ParallelSimCluster.m','Multi_Sim.m','CPMGSim.m','xrot.m','yrot.m','zrot.m','computeProtonPath.m','computeProtonPath2.m'},'Pool',numWorkersSim);
                job
                wait(job)
