...
simOutput.runParams(1).FAExcite = 48;
simOutput.runParams(1).FAEcho = 'x2';
simOutput.runParams(1).useInstantExcitation = 1;
simOutput.runParams(1).SimSelect = 'CPMG';


simOutput.runParams(2).FAExcite = 54;
simOutput.runParams(2).FAEcho = 'x2';
simOutput.runParams(2).useInstantExcitation = 1;
simOutput.runParams(2).SimSelect = 'CPMG';


simOutput.runParams(3).FAExcite = 60;
simOutput.runParams(3).FAEcho = 'x2';
simOutput.runParams(3).useInstantExcitation = 1;
simOutput.runParams(3).SimSelect = 'CPMG';

simOutput.runParams(3).FAExcite = 66;
simOutput.runParams(3).FAEcho = 'x2';
simOutput.runParams(3).useInstantExcitation = 1;
simOutput.runParams(3).SimSelect = 'CPMG';

simOutput.runParams(4).FAExcite = 72;
simOutput.runParams(4).FAEcho = 'x2';
simOutput.runParams(4).useInstantExcitation = 1;
simOutput.runParams(4).SimSelect = 'CPMG';

simOutput.runParams(5).FAExcite = 78;
simOutput.runParams(5).FAEcho = 'x2';
simOutput.runParams(5).useInstantExcitation = 1;
simOutput.runParams(5).SimSelect = 'CPMG';

simOutput.runParams(6).FAExcite = 84;
simOutput.runParams(6).FAEcho = 'x2';
simOutput.runParams(6).useInstantExcitation = 1;
simOutput.runParams(6).SimSelect = 'CPMG';

simOutput.runParams(7).FAExcite = 90;
simOutput.runParams(7).FAEcho = 'x2';
simOutput.runParams(7).useInstantExcitation = 1;
simOutput.runParams(7).SimSelect = 'CPMG';

simOutput.runParams(8).FAExcite = 96;
simOutput.runParams(8).FAEcho = 'x2';
simOutput.runParams(8).useInstantExcitation = 1;
simOutput.runParams(8).SimSelect = 'CPMG';

simOutput.runParams(9).FAExcite = 102;
simOutput.runParams(9).FAEcho = 'x2';
simOutput.runParams(9).useInstantExcitation = 1;
simOutput.runParams(9).SimSelect = 'CPMG';

simOutput.runParams(10).FAExcite = 108;
simOutput.runParams(10).FAEcho = 'x2';
simOutput.runParams(10).useInstantExcitation = 1;
simOutput.runParams(10).SimSelect = 'CPMG';

simOutput.runParams(11).FAExcite = 114;
simOutput.runParams(11).FAEcho = 'x2';
simOutput.runParams(11).useInstantExcitation = 1;
simOutput.runParams(11).SimSelect = 'CPMG';
