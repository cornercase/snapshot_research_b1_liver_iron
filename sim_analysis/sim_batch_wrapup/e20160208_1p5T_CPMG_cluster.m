...
simOutput.runParams(end+1).FAExcite = 66;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 72;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 78;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 84;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 90;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 96;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 102;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 108;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';

simOutput.runParams(end+1).FAExcite = 114;
simOutput.runParams(end).FAEcho = 'x2';
simOutput.runParams(end).useInstantExcitation = 1;
simOutput.runParams(end).SimSelect = 'CPMG';
    ...
    for FEselect = runcounter:length(FE)
        if hpcc == 1
            ...
            job = batch(cluster,'ParallelSimClusterLocalFields', ...
                    'AttachedFiles',{'ParallelSimClusterLocalFields.m','Multi_Sim.m','CPMGSim.m',...
                        'xrot.m','yrot.m','zrot.m','computeProtonPath.m','computeProtonPath2.m'},'Pool',numWorkersSim);
